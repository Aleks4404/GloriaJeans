...
//        options.addArguments("headless");
    ...
    public void  shouldLogInWithAnInvalidPhoneNumber(){
        ...
        String actual = driver.findElement(By.xpath("//div[3]/div[1]/div[3]/form/div[1]/div/p[2]")).getText();
        assertEquals(expected, actual);
    }
    ...
    @Test
    @DisplayName("Подписка с валидной почтой")
    public void shouldSubscriptionWithValidEmail() {
        driver.findElement(By.xpath("//*[text()='Да, верно']")).click();
        driver.findElement(By.cssSelector("body")).sendKeys(Keys.CONTROL, Keys.END);
        driver.findElement(By.id("email")).sendKeys(DataHelper.generateEmail());
        driver.findElement(By.id("subscribe_front")).click();
        String expected = "СПАСИБО ЗА ПОДПИСКУ!";
        String actual = driver.findElement(By.cssSelector("h1.caption.caption-32-tablet-21.caption--uppercase.caption--bold.caption--center.mobile-text-left.caption--ls1px")).getText();
        assertEquals(expected, actual);
    }

    @Test
    @DisplayName("Подписка с невалидной почтой")
    public void shouldSubscriptionWithInvalidEmail() {
        driver.findElement(By.xpath("//*[text()='Да, верно']")).click();
        driver.findElement(By.cssSelector("body")).sendKeys(Keys.CONTROL, Keys.END);
        driver.findElement(By.id("email")).sendKeys(DataHelper.getInvalideEmail());
        String expected = "Пожалуйста, введите корректный адрес электронной почты.";
        String actual = driver.findElement(By.xpath("//*[@id=\"subscription\"]/div/div/form/div/p")).getText();
        assertEquals(expected, actual);
    }
